<?php
/*
 * Plugin Name: XTCZ Top Box Office
 * Description: XTCZ Top Box office provides real time ranking of the box office and always keep users upto date with latest box office results. The data updates automatically every week, no need to do any extra work. This plugin is powered by <a href="http://www.xtcz.net/">xtcz.net</a>.
 * Version: 2.0
 * License:  GNU General Public License 3.0 or newer (GPL) http://www.gnu.org/licenses/gpl.html
 * Author: Harish Kumar   
 * Author URI: http://www.xtcz.net/ 
 */
